...
class SettingsServiceCryptoCompatibilityTest {
    ...
    void decryptsPythonCompatibleCiphertextVector() {
        assertThat(SettingsService.decryptSecret("ABEiM0RVZneImaq7zN3u_21dRzgKx2qy8JevEwLIIFUD", "test-master-key"))
                .isEqualTo("smtp-password-123");

        assertThat(SettingsService.decryptSecret("_ty6mHZUMhABI0VniavN7zIGQz9ZYjfxOCYxHg==", "master-key-2"))
                .isEqualTo("пароль");
    }
