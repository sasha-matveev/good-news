...
class FeedFeedbackWantToReadApiTest {
    ...
    void cleanDatabase() {
        databaseClient
                .sql("TRUNCATE TABLE read_later, post_analysis, feedback, posts, sources RESTART IDENTITY CASCADE")
                .then()
                .block();
    }
    ...
    void getPostsDefaultsToLastMonthAndReturnsRankingExplanation() {
        ...
        insertPost(
                1,
                1,
                "https://alpha.example/posts/older",
                "Older",
        ...
        insertPost(
                ...
                "Fresh enough for the default window.");
    ...
    void getPostsSupportsFilteringSortingAndPagination() throws Exception {
        ...
        insertPost(
                2,
                1,
                "https://alpha.example/posts/two",
                "Newer but low relevance",
                utc("2026-04-25T08:00:00Z"),
                "Newer content.");
        insertPost(
                3,
                1,
                "https://alpha.example/posts/three",
                "Untouched",
                utc("2026-04-26T08:00:00Z"),
                "No feedback yet.");
    ...
    void feedbackApisPreserveUpsertAndDigestRedirectContract() {
        ...
        webTestClient
                ...
                .expectHeader()
                .location(
                        "https://good-news.example/want-to-read?digest_id=21&feedback=want_to_read&from=digest_email&post_id=1");
        ...
        webTestClient
                ...
                .expectHeader()
                .location(
                        "https://good-news.example/digests?digest_id=22&feedback=interesting&from=digest_email&post_id=1");
    }
    ...
    private void insertReadLater(long postId) {
        databaseClient
                .sql("INSERT INTO read_later (post_id, created_at) VALUES (:postId, NOW())")
                .bind("postId", postId)
                .then()
                .block();
    }
