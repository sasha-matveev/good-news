...
class ReactiveDatabaseConfigTest {
    ...
    void derivesReactiveConnectionOptionsFromStructuredProperties() {
        DatabaseProperties properties =
                new DatabaseProperties(null, "db.internal", 6432, "good_news_prod", "service_user", "top-secret");

        String options =
                new ConfiguredDatabase(properties).connectionFactoryOptions().toString();
    ...
    void treatsPasswordlessStructuredOverridesAsExplicitDatabaseConfiguration() {
        DatabaseProperties properties =
                new DatabaseProperties(null, "db.internal", 5432, "good_news", DatabaseProperties.DEFAULT_USER, null);
    ...
    void rejectsUnsupportedUrlSchemesEarly() {
        DatabaseProperties properties = new DatabaseProperties(
                "mysql://db.example/good_news", "localhost", 5432, "good_news", "service_user", "top-secret");
