...
public final class DigestDtos {
    ...
    public record DigestListItemResponse(
            long id, String digest_type, String status, String sent_at, int included_post_count) {}

    public record DigestIncludedPostResponse(long post_id, String title, String feedback_state) {}
