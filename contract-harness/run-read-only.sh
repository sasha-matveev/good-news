...
export GOOD_NEWS_CONTRACT_JAVA_DATABASE_URL="$GOOD_NEWS_CONTRACT_PYTHON_DATABASE_URL"
export GOOD_NEWS_CONTRACT_SIDE_EFFECTS_URL=http://127.0.0.1:18090
export GOOD_NEWS_CONTRACT_ROOT="$HARNESS_DIR"

python3 -m good_news_contract.cli --mode read-only --report "$REPOSITORY_DIR/artifacts/backend-parity-read-only.md"
